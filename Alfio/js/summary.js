function showFinalSummary() {
  ...
  quizSummary.forEach(function (element) {
    ...
    card.className = "summary-card"; //creiamo il testo della domanda
    const pQuestion = document.createElement("p");
    pQuestion.textContent = element.questionText;
    pQuestion.className = "question-title"; //creiamo il testo della risposta data
    const pAnswer = document.createElement("p");
    pAnswer.textContent = "Your Answer:" + element.userAnswer; //controllo dell'esito
